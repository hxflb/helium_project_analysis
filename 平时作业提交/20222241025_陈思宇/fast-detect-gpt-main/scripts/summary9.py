...
def run(args):
    ...
    #print('')
    file_path = "data/archive (4)/final_test.csv"
    human_count = 0
    ai_count = 0
    human_correct = 0
    ai_correct = 0
    ...
    for index in range(len(df)):
        ...
        if isinstance(text, str): #and len(text) > 50:
            ...
            if type(text) == str and len(text) > 10 and len(text):
                print(text + "\n")
                if df.iat[index, 1] == 0:
                    human_count += 1
                else:
                ...
                if predicted_class == df.iat[index, 1] and df.iat[index, 1] == 0:
                    human_correct += 1
                elif predicted_class == df.iat[index, 1] and df.iat[index, 1] == 1:
                    ai_correct += 1
                ...
                if processed_class == df.iat[index, 1] and df.iat[index, 1] == 0:
                    processed_human_correct += 1
                elif processed_class == df.iat[index, 1] and df.iat[index, 1] == 1:
